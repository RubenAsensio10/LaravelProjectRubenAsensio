<header class="bg-header h-header text-white flex justify-between items-center">
    ...
    <div class="space-x-2">
        @guest
        <a href="{{ route('login') }}"><button class="bg-white px-4 py-2 rounded-md text-black font-medium">Login</button></a>
        <a href="{{ route('register') }}"><button class="bg-gray-300 px-6 py-2 rounded-md text-black font-medium">Register</button></a>
